                                ...
                                <div className="relative mb-6">
                                    <div className="flex">
                                        ...
                                        <input
                                            ...
                                            className="rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-teal-500 focus:border-teal-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5"
