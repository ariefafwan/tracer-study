...
export const EditLowongan = () => {
    ...
    const [lowonganForm, setLowonganForm] = useState({
        ...
        tanggal_mulai: "",
        tanggal_selesai: "",
        data_kualifikasi_prodi: [{ label: "", value: "" }],
    ...
    useEffect(() => {
        axios
            ...
            .then((res) => {
                setLowonganForm({
                    id: res.data.id,
                    judul_lowongan: res.data.judul_lowongan,
                    nama_perusahaan: res.data.nama_perusahaan,
                    logo_perusahaan: "",
                    kota: res.data.kota,
                    link_lowongan: res.data.link_lowongan,
                    bidang_usaha: {
                        label: res.data.bidang_usaha,
                        value: res.data.bidang_usaha,
                    },
                    desk: res.data.desk,
                    tanggal_mulai: res.data.tanggal_mulai,
                    tanggal_selesai: res.data.tanggal_selesai,
                    data_kualifikasi_prodi: res.data.data_kualifikasi_prodi.map(
                        (data) => {
                            return {
                                label: data.data_prodi.nama,
                                value: data.data_prodi.id,
                            };
                        }
                    ),
                    data_kualifikasi_umum: res.data.data_kualifikasi_umum.map(
                        (data) => {
                            return {
                                label: data.kualifikasi,
