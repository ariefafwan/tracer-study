...
export const Fakultas = () => {
    ...
    const [modalFakultas, setModalFakultas] = useState(false);
    const [fakultasForm, setFakultasFrom] = useState({
        id: 0,
        nama: "",
    });
    ...
    useEffect(() => {
        ...
        axios
            .get(
                ...
                }/data-master/fakultas?page=${page}&q=${search}&paginate=${paginate}`,
                {
                    headers: {
    ...
    useEffect(() => {
        if (modalFakultas == false) {
            setFakultasFrom({
                id: 0,
                nama: "",
            });
        }
    }, [modalFakultas, setModalFakultas]);
    ...
    const handlerSubmit = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                if (fakultasForm.id == 0) {
                    axios
                        .post(
                            `${
                                import.meta.env.VITE_ALL_BASE_URL
                            }/data-master/fakultas/store`,
                            fakultasForm,
                            {
                                headers: {
                                    Authorization:
            ...
            if (result.isConfirmed) {
                ...
                axios
                    .delete(
                        `${
                            import.meta.env.VITE_ALL_BASE_URL
                        }/data-master/fakultas/delete/${id}`,
                        {
                            headers: {
                                Authorization: "Bearer " + Cookies.get("token"),
                            },
        ...
        <>
            <DashboardLayout>
                ...
                <ModalPrimary
                    ...
                    closeModal={() => setModalFakultas(false)}
                >
